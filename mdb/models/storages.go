...
func (q storageQuery) One() (*Storage, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for storages")
	}
...
func (q storageQuery) All() (StorageSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to Storage slice")
	}
...
func (q storageQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count storages rows")
	}
...
func (q storageQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if storages exists")
	}
...
func FindStorage(exec boil.Executor, id int64, selectCols ...string) (*Storage, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from storages")
	}
...
func (o *Storage) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no storages provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into storages")
	}
...
func (o *Storage) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update storages, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update storages row")
	}
...
func (q storageQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for storages")
	}
...
func (o StorageSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in storage slice")
	}
...
func (o *Storage) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Storage provided for deletion")
	}
...
func (o *Storage) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Storage provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from storages")
	}
...
func (q storageQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no storageQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from storages")
	}
...
func (o StorageSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Storage slice provided for delete all")
	}
...
func (o StorageSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from storage slice")
	}
...
func (o *Storage) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Storage provided for reload")
	}
...
func (o *StorageSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty StorageSlice provided for reload all")
	}
...
func (o *StorageSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&storages)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in StorageSlice")
	}
...
func StorageExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if storages exists")
	}
