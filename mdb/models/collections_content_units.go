...
func (q collectionsContentUnitQuery) One() (*CollectionsContentUnit, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for collections_content_units")
	}
...
func (q collectionsContentUnitQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count collections_content_units rows")
	}
...
func (q collectionsContentUnitQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if collections_content_units exists")
	}
...
func FindCollectionsContentUnit(exec boil.Executor, collectionID int64, contentUnitID int64, selectCols ...string) (*CollectionsContentUnit, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from collections_content_units")
	}
...
func (o *CollectionsContentUnit) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no collections_content_units provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into collections_content_units")
	}
...
func (o *CollectionsContentUnit) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update collections_content_units, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update collections_content_units row")
	}
...
func (q collectionsContentUnitQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for collections_content_units")
	}
...
func (o CollectionsContentUnitSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in collectionsContentUnit slice")
	}
...
func (o *CollectionsContentUnit) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no collections_content_units provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert collections_content_units, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert collections_content_units")
	}
...
func (o *CollectionsContentUnit) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no CollectionsContentUnit provided for deletion")
	}
...
func (o *CollectionsContentUnit) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no CollectionsContentUnit provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from collections_content_units")
	}
...
func (q collectionsContentUnitQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no collectionsContentUnitQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from collections_content_units")
	}
...
func (o CollectionsContentUnitSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no CollectionsContentUnit slice provided for delete all")
	}
...
func (o CollectionsContentUnitSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from collectionsContentUnit slice")
	}
...
func (o *CollectionsContentUnit) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no CollectionsContentUnit provided for reload")
	}
...
func (o *CollectionsContentUnitSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty CollectionsContentUnitSlice provided for reload all")
	}
...
func CollectionsContentUnitExists(exec boil.Executor, collectionID int64, contentUnitID int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if collections_content_units exists")
	}
