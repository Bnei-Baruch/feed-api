...
func (q sourceTypeQuery) One() (*SourceType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for source_types")
	}
...
func (q sourceTypeQuery) All() (SourceTypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to SourceType slice")
	}
...
func (q sourceTypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count source_types rows")
	}
...
func (q sourceTypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if source_types exists")
	}
...
func FindSourceType(exec boil.Executor, id int64, selectCols ...string) (*SourceType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from source_types")
	}
...
func (o *SourceType) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no source_types provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into source_types")
	}
...
func (o *SourceType) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update source_types, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update source_types row")
	}
...
func (q sourceTypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for source_types")
	}
...
func (o SourceTypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in sourceType slice")
	}
...
func (o *SourceType) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no source_types provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert source_types, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert source_types")
	}
...
func (o *SourceType) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no SourceType provided for deletion")
	}
...
func (q sourceTypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no sourceTypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from source_types")
	}
...
func (o SourceTypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no SourceType slice provided for delete all")
	}
...
func (o SourceTypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from sourceType slice")
	}
...
func (o *SourceType) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no SourceType provided for reload")
	}
...
func (o *SourceTypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty SourceTypeSlice provided for reload all")
	}
...
func (o *SourceTypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in SourceTypeSlice")
	}
...
func SourceTypeExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if source_types exists")
	}
