...
func (q operationQuery) One() (*Operation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for operations")
	}
...
func (q operationQuery) All() (OperationSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to Operation slice")
	}
...
func (q operationQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count operations rows")
	}
...
func (q operationQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if operations exists")
	}
...
func FindOperation(exec boil.Executor, id int64, selectCols ...string) (*Operation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from operations")
	}
...
func (o *Operation) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no operations provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into operations")
	}
...
func (o *Operation) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update operations, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update operations row")
	}
...
func (q operationQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for operations")
	}
...
func (o OperationSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in operation slice")
	}
...
func (o *Operation) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no operations provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert operations, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert operations")
	}
...
func (o *Operation) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Operation provided for deletion")
	}
...
func (o *Operation) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Operation provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from operations")
	}
...
func (q operationQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no operationQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from operations")
	}
...
func (o OperationSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Operation slice provided for delete all")
	}
...
func (o OperationSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from operation slice")
	}
...
func (o *Operation) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Operation provided for reload")
	}
...
func (o *OperationSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty OperationSlice provided for reload all")
	}
...
func OperationExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if operations exists")
	}
