...
func (q contentRoleTypeQuery) One() (*ContentRoleType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for content_role_types")
	}
...
func (q contentRoleTypeQuery) All() (ContentRoleTypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to ContentRoleType slice")
	}
...
func (q contentRoleTypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count content_role_types rows")
	}
...
func (q contentRoleTypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if content_role_types exists")
	}
...
func FindContentRoleType(exec boil.Executor, id int64, selectCols ...string) (*ContentRoleType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from content_role_types")
	}
...
func (o *ContentRoleType) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_role_types provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into content_role_types")
	}
...
func (o *ContentRoleType) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update content_role_types, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update content_role_types row")
	}
...
func (q contentRoleTypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for content_role_types")
	}
...
func (o ContentRoleTypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in contentRoleType slice")
	}
...
func (o *ContentRoleType) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_role_types provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert content_role_types, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert content_role_types")
	}
...
func (o *ContentRoleType) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentRoleType provided for deletion")
	}
...
func (o *ContentRoleType) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentRoleType provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from content_role_types")
	}
...
func (q contentRoleTypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no contentRoleTypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from content_role_types")
	}
...
func (o ContentRoleTypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentRoleType slice provided for delete all")
	}
...
func (o ContentRoleTypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from contentRoleType slice")
	}
...
func (o *ContentRoleType) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentRoleType provided for reload")
	}
...
func (o *ContentRoleTypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty ContentRoleTypeSlice provided for reload all")
	}
...
func (o *ContentRoleTypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in ContentRoleTypeSlice")
	}
...
func ContentRoleTypeExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if content_role_types exists")
	}
