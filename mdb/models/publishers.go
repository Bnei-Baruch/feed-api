...
func (q publisherQuery) One() (*Publisher, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for publishers")
	}
...
func (q publisherQuery) All() (PublisherSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to Publisher slice")
	}
...
func (q publisherQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count publishers rows")
	}
...
func (q publisherQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if publishers exists")
	}
...
func FindPublisher(exec boil.Executor, id int64, selectCols ...string) (*Publisher, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from publishers")
	}
...
func (o *Publisher) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no publishers provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into publishers")
	}
...
func (o *Publisher) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update publishers, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update publishers row")
	}
...
func (q publisherQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for publishers")
	}
...
func (o PublisherSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in publisher slice")
	}
...
func (o *Publisher) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no publishers provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert publishers, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert publishers")
	}
...
func (o *Publisher) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Publisher provided for deletion")
	}
...
func (o *Publisher) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Publisher provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from publishers")
	}
...
func (q publisherQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no publisherQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from publishers")
	}
...
func (o PublisherSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Publisher slice provided for delete all")
	}
...
func (o PublisherSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from publisher slice")
	}
...
func (o *Publisher) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Publisher provided for reload")
	}
...
func (o *PublisherSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty PublisherSlice provided for reload all")
	}
...
func (o *PublisherSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in PublisherSlice")
	}
...
func PublisherExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if publishers exists")
	}
