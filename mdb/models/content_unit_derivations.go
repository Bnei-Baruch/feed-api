...
func (q contentUnitDerivationQuery) One() (*ContentUnitDerivation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for content_unit_derivations")
	}
...
func (q contentUnitDerivationQuery) All() (ContentUnitDerivationSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to ContentUnitDerivation slice")
	}
...
func (q contentUnitDerivationQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count content_unit_derivations rows")
	}
...
func (q contentUnitDerivationQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if content_unit_derivations exists")
	}
...
func FindContentUnitDerivation(exec boil.Executor, sourceID int64, derivedID int64, selectCols ...string) (*ContentUnitDerivation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from content_unit_derivations")
	}
...
func (o *ContentUnitDerivation) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_unit_derivations provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into content_unit_derivations")
	}
...
func (o *ContentUnitDerivation) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update content_unit_derivations, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update content_unit_derivations row")
	}
...
func (q contentUnitDerivationQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for content_unit_derivations")
	}
...
func (o ContentUnitDerivationSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in contentUnitDerivation slice")
	}
...
func (o *ContentUnitDerivation) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_unit_derivations provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert content_unit_derivations, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert content_unit_derivations")
	}
...
func (o *ContentUnitDerivation) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitDerivation provided for deletion")
	}
...
func (o *ContentUnitDerivation) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitDerivation provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from content_unit_derivations")
	}
...
func (q contentUnitDerivationQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no contentUnitDerivationQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from content_unit_derivations")
	}
...
func (o ContentUnitDerivationSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitDerivation slice provided for delete all")
	}
...
func (o ContentUnitDerivationSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from contentUnitDerivation slice")
	}
...
func (o *ContentUnitDerivation) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitDerivation provided for reload")
	}
...
func (o *ContentUnitDerivationSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty ContentUnitDerivationSlice provided for reload all")
	}
...
func (o *ContentUnitDerivationSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in ContentUnitDerivationSlice")
	}
...
func ContentUnitDerivationExists(exec boil.Executor, sourceID int64, derivedID int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if content_unit_derivations exists")
	}
