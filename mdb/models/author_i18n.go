...
func (q authorI18nQuery) One() (*AuthorI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for author_i18n")
	}
...
func (q authorI18nQuery) All() (AuthorI18nSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to AuthorI18n slice")
	}
...
func (q authorI18nQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count author_i18n rows")
	}
...
func (q authorI18nQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if author_i18n exists")
	}
...
func FindAuthorI18n(exec boil.Executor, authorID int64, language string, selectCols ...string) (*AuthorI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from author_i18n")
	}
...
func (o *AuthorI18n) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no author_i18n provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into author_i18n")
	}
...
func (o *AuthorI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update author_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update author_i18n row")
	}
...
func (q authorI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for author_i18n")
	}
...
func (o AuthorI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in authorI18n slice")
	}
...
func (o *AuthorI18n) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no author_i18n provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert author_i18n, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert author_i18n")
	}
...
func (o *AuthorI18n) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no AuthorI18n provided for deletion")
	}
...
func (o *AuthorI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no AuthorI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from author_i18n")
	}
...
func (q authorI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no authorI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from author_i18n")
	}
...
func (o AuthorI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no AuthorI18n slice provided for delete all")
	}
...
func (o AuthorI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from authorI18n slice")
	}
...
func (o *AuthorI18n) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no AuthorI18n provided for reload")
	}
...
func (o *AuthorI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty AuthorI18nSlice provided for reload all")
	}
...
func (o *AuthorI18nSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in AuthorI18nSlice")
	}
...
func AuthorI18nExists(exec boil.Executor, authorID int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if author_i18n exists")
	}
