...
func (q personQuery) One() (*Person, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for persons")
	}
...
func (q personQuery) All() (PersonSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to Person slice")
	}
...
func (q personQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count persons rows")
	}
...
func (q personQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if persons exists")
	}
...
func FindPerson(exec boil.Executor, id int64, selectCols ...string) (*Person, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from persons")
	}
...
func (o *Person) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no persons provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into persons")
	}
...
func (o *Person) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update persons, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update persons row")
	}
...
func (q personQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for persons")
	}
...
func (o PersonSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in person slice")
	}
...
func (o *Person) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no persons provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert persons, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert persons")
	}
...
func (o *Person) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Person provided for deletion")
	}
...
func (o *Person) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Person provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from persons")
	}
...
func (q personQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no personQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from persons")
	}
...
func (o PersonSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Person slice provided for delete all")
	}
...
func (o PersonSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from person slice")
	}
...
func (o *Person) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no Person provided for reload")
	}
...
func (o *PersonSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty PersonSlice provided for reload all")
	}
...
func (o *PersonSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&persons)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in PersonSlice")
	}
...
func PersonExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if persons exists")
	}
