...
func (q contentUnitsPersonQuery) One() (*ContentUnitsPerson, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for content_units_persons")
	}
...
func (q contentUnitsPersonQuery) All() (ContentUnitsPersonSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to ContentUnitsPerson slice")
	}
...
func (q contentUnitsPersonQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count content_units_persons rows")
	}
...
func (q contentUnitsPersonQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if content_units_persons exists")
	}
...
func FindContentUnitsPerson(exec boil.Executor, contentUnitID int64, personID int64, selectCols ...string) (*ContentUnitsPerson, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from content_units_persons")
	}
...
func (o *ContentUnitsPerson) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_units_persons provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into content_units_persons")
	}
...
func (o *ContentUnitsPerson) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update content_units_persons, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update content_units_persons row")
	}
...
func (q contentUnitsPersonQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for content_units_persons")
	}
...
func (o ContentUnitsPersonSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in contentUnitsPerson slice")
	}
...
func (o *ContentUnitsPerson) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_units_persons provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert content_units_persons, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert content_units_persons")
	}
...
func (o *ContentUnitsPerson) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitsPerson provided for deletion")
	}
...
func (o *ContentUnitsPerson) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitsPerson provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from content_units_persons")
	}
...
func (q contentUnitsPersonQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no contentUnitsPersonQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from content_units_persons")
	}
...
func (o ContentUnitsPersonSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitsPerson slice provided for delete all")
	}
...
func (o ContentUnitsPersonSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from contentUnitsPerson slice")
	}
...
func (o *ContentUnitsPerson) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitsPerson provided for reload")
	}
...
func (o *ContentUnitsPersonSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty ContentUnitsPersonSlice provided for reload all")
	}
...
func (o *ContentUnitsPersonSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in ContentUnitsPersonSlice")
	}
...
func ContentUnitsPersonExists(exec boil.Executor, contentUnitID int64, personID int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if content_units_persons exists")
	}
