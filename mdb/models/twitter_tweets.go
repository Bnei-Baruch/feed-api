...
func (q twitterTweetQuery) One() (*TwitterTweet, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for twitter_tweets")
	}
...
func (q twitterTweetQuery) All() (TwitterTweetSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to TwitterTweet slice")
	}
...
func (q twitterTweetQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count twitter_tweets rows")
	}
...
func (q twitterTweetQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if twitter_tweets exists")
	}
...
func FindTwitterTweet(exec boil.Executor, id int64, selectCols ...string) (*TwitterTweet, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from twitter_tweets")
	}
...
func (o *TwitterTweet) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no twitter_tweets provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into twitter_tweets")
	}
...
func (o *TwitterTweet) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update twitter_tweets, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update twitter_tweets row")
	}
...
func (q twitterTweetQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for twitter_tweets")
	}
...
func (o TwitterTweetSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in twitterTweet slice")
	}
...
func (o *TwitterTweet) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no twitter_tweets provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert twitter_tweets, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert twitter_tweets")
	}
...
func (o *TwitterTweet) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TwitterTweet provided for deletion")
	}
...
func (o *TwitterTweet) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TwitterTweet provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from twitter_tweets")
	}
...
func (q twitterTweetQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no twitterTweetQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from twitter_tweets")
	}
...
func (o TwitterTweetSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TwitterTweet slice provided for delete all")
	}
...
func (o TwitterTweetSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from twitterTweet slice")
	}
...
func (o *TwitterTweet) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TwitterTweet provided for reload")
	}
...
func (o *TwitterTweetSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty TwitterTweetSlice provided for reload all")
	}
...
func (o *TwitterTweetSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in TwitterTweetSlice")
	}
...
func TwitterTweetExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if twitter_tweets exists")
	}
