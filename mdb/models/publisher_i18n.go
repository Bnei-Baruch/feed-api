...
func (q publisherI18nQuery) One() (*PublisherI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for publisher_i18n")
	}
...
func (q publisherI18nQuery) All() (PublisherI18nSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to PublisherI18n slice")
	}
...
func (q publisherI18nQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count publisher_i18n rows")
	}
...
func FindPublisherI18n(exec boil.Executor, publisherID int64, language string, selectCols ...string) (*PublisherI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from publisher_i18n")
	}
...
func (o *PublisherI18n) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no publisher_i18n provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into publisher_i18n")
	}
...
func (o *PublisherI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update publisher_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update publisher_i18n row")
	}
...
func (q publisherI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for publisher_i18n")
	}
...
func (o PublisherI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in publisherI18n slice")
	}
...
func (o *PublisherI18n) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no publisher_i18n provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert publisher_i18n, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert publisher_i18n")
	}
...
func (o *PublisherI18n) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no PublisherI18n provided for deletion")
	}
...
func (o *PublisherI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no PublisherI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from publisher_i18n")
	}
...
func (q publisherI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no publisherI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from publisher_i18n")
	}
...
func (o PublisherI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no PublisherI18n slice provided for delete all")
	}
...
func (o PublisherI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from publisherI18n slice")
	}
...
func (o *PublisherI18n) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no PublisherI18n provided for reload")
	}
...
func (o *PublisherI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty PublisherI18nSlice provided for reload all")
	}
...
func (o *PublisherI18nSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in PublisherI18nSlice")
	}
...
func PublisherI18nExists(exec boil.Executor, publisherID int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if publisher_i18n exists")
	}
