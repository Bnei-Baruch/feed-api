...
func (q personI18nQuery) One() (*PersonI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for person_i18n")
	}
...
func (q personI18nQuery) All() (PersonI18nSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to PersonI18n slice")
	}
...
func (q personI18nQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count person_i18n rows")
	}
...
func (q personI18nQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if person_i18n exists")
	}
...
func FindPersonI18n(exec boil.Executor, personID int64, language string, selectCols ...string) (*PersonI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from person_i18n")
	}
...
func (o *PersonI18n) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no person_i18n provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into person_i18n")
	}
...
func (o *PersonI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update person_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update person_i18n row")
	}
...
func (q personI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for person_i18n")
	}
...
func (o PersonI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in personI18n slice")
	}
...
func (o *PersonI18n) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no person_i18n provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert person_i18n, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert person_i18n")
	}
...
func (o *PersonI18n) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no PersonI18n provided for deletion")
	}
...
func (o *PersonI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no PersonI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from person_i18n")
	}
...
func (q personI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no personI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from person_i18n")
	}
...
func (o PersonI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no PersonI18n slice provided for delete all")
	}
...
func (o PersonI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from personI18n slice")
	}
...
func (o *PersonI18n) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no PersonI18n provided for reload")
	}
...
func (o *PersonI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty PersonI18nSlice provided for reload all")
	}
...
func (o *PersonI18nSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in PersonI18nSlice")
	}
...
func PersonI18nExists(exec boil.Executor, personID int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if person_i18n exists")
	}
