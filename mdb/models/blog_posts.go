...
func (q blogPostQuery) One() (*BlogPost, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for blog_posts")
	}
...
func (q blogPostQuery) All() (BlogPostSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to BlogPost slice")
	}
...
func (q blogPostQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count blog_posts rows")
	}
...
func (q blogPostQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if blog_posts exists")
	}
...
func FindBlogPost(exec boil.Executor, id int64, selectCols ...string) (*BlogPost, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from blog_posts")
	}
...
func (o *BlogPost) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no blog_posts provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into blog_posts")
	}
...
func (o *BlogPost) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update blog_posts, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update blog_posts row")
	}
...
func (o BlogPostSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in blogPost slice")
	}
...
func (o *BlogPost) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no blog_posts provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert blog_posts, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert blog_posts")
	}
...
func (o *BlogPost) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no BlogPost provided for deletion")
	}
...
func (o *BlogPost) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no BlogPost provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from blog_posts")
	}
...
func (q blogPostQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no blogPostQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from blog_posts")
	}
...
func (o BlogPostSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no BlogPost slice provided for delete all")
	}
...
func (o BlogPostSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from blogPost slice")
	}
...
func (o *BlogPost) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no BlogPost provided for reload")
	}
...
func (o *BlogPostSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty BlogPostSlice provided for reload all")
	}
...
func (o *BlogPostSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in BlogPostSlice")
	}
...
func BlogPostExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if blog_posts exists")
	}
