...
func (q twitterUserQuery) One() (*TwitterUser, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for twitter_users")
	}
...
func (q twitterUserQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count twitter_users rows")
	}
...
func (q twitterUserQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if twitter_users exists")
	}
...
func FindTwitterUser(exec boil.Executor, id int64, selectCols ...string) (*TwitterUser, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from twitter_users")
	}
...
func (o *TwitterUser) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no twitter_users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into twitter_users")
	}
...
func (o *TwitterUser) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update twitter_users, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update twitter_users row")
	}
...
func (q twitterUserQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for twitter_users")
	}
...
func (o TwitterUserSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in twitterUser slice")
	}
...
func (o *TwitterUser) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no twitter_users provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert twitter_users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert twitter_users")
	}
...
func (o *TwitterUser) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TwitterUser provided for deletion")
	}
...
func (o *TwitterUser) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TwitterUser provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from twitter_users")
	}
...
func (q twitterUserQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no twitterUserQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from twitter_users")
	}
...
func (o TwitterUserSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TwitterUser slice provided for delete all")
	}
...
func (o TwitterUserSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from twitterUser slice")
	}
...
func (o *TwitterUser) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TwitterUser provided for reload")
	}
...
func (o *TwitterUserSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty TwitterUserSlice provided for reload all")
	}
...
func (o *TwitterUserSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in TwitterUserSlice")
	}
...
func TwitterUserExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if twitter_users exists")
	}
