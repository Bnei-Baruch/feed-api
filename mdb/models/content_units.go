...
func (q contentUnitQuery) All() (ContentUnitSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to ContentUnit slice")
	}
...
func (q contentUnitQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count content_units rows")
	}
...
func (q contentUnitQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if content_units exists")
	}
...
func FindContentUnit(exec boil.Executor, id int64, selectCols ...string) (*ContentUnit, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from content_units")
	}
...
func (o *ContentUnit) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_units provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into content_units")
	}
...
func (o *ContentUnit) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update content_units, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update content_units row")
	}
...
func (q contentUnitQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for content_units")
	}
...
func (o ContentUnitSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in contentUnit slice")
	}
...
func (o *ContentUnit) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnit provided for deletion")
	}
...
func (o *ContentUnit) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnit provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from content_units")
	}
...
func (q contentUnitQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no contentUnitQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from content_units")
	}
...
func (o ContentUnitSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnit slice provided for delete all")
	}
...
func (o ContentUnitSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from contentUnit slice")
	}
...
func (o *ContentUnit) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnit provided for reload")
	}
...
func (o *ContentUnitSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty ContentUnitSlice provided for reload all")
	}
...
func (o *ContentUnitSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in ContentUnitSlice")
	}
...
func ContentUnitExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if content_units exists")
	}
