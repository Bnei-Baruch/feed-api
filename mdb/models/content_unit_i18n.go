...
func (q contentUnitI18nQuery) One() (*ContentUnitI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for content_unit_i18n")
	}
...
func (q contentUnitI18nQuery) All() (ContentUnitI18nSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to ContentUnitI18n slice")
	}
...
func (q contentUnitI18nQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count content_unit_i18n rows")
	}
...
func (q contentUnitI18nQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if content_unit_i18n exists")
	}
...
func FindContentUnitI18n(exec boil.Executor, contentUnitID int64, language string, selectCols ...string) (*ContentUnitI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from content_unit_i18n")
	}
...
func (o *ContentUnitI18n) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_unit_i18n provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into content_unit_i18n")
	}
...
func (o *ContentUnitI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update content_unit_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update content_unit_i18n row")
	}
...
func (q contentUnitI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for content_unit_i18n")
	}
...
func (o ContentUnitI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in contentUnitI18n slice")
	}
...
func (o *ContentUnitI18n) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no content_unit_i18n provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert content_unit_i18n, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert content_unit_i18n")
	}
...
func (o *ContentUnitI18n) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitI18n provided for deletion")
	}
...
func (o *ContentUnitI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from content_unit_i18n")
	}
...
func (q contentUnitI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no contentUnitI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from content_unit_i18n")
	}
...
func (o ContentUnitI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitI18n slice provided for delete all")
	}
...
func (o ContentUnitI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from contentUnitI18n slice")
	}
...
func (o *ContentUnitI18n) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no ContentUnitI18n provided for reload")
	}
...
func (o *ContentUnitI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty ContentUnitI18nSlice provided for reload all")
	}
...
func (o *ContentUnitI18nSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in ContentUnitI18nSlice")
	}
...
func ContentUnitI18nExists(exec boil.Executor, contentUnitID int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if content_unit_i18n exists")
	}
