...
func (q operationTypeQuery) One() (*OperationType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for operation_types")
	}
...
func (q operationTypeQuery) All() (OperationTypeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to OperationType slice")
	}
...
func (q operationTypeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count operation_types rows")
	}
...
func (q operationTypeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if operation_types exists")
	}
...
func FindOperationType(exec boil.Executor, id int64, selectCols ...string) (*OperationType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from operation_types")
	}
...
func (o *OperationType) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no operation_types provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into operation_types")
	}
...
func (o *OperationType) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update operation_types, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update operation_types row")
	}
...
func (q operationTypeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for operation_types")
	}
...
func (o OperationTypeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in operationType slice")
	}
...
func (o *OperationType) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no operation_types provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert operation_types, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert operation_types")
	}
...
func (o *OperationType) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no OperationType provided for deletion")
	}
...
func (o *OperationType) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no OperationType provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from operation_types")
	}
...
func (q operationTypeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no operationTypeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from operation_types")
	}
...
func (o OperationTypeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no OperationType slice provided for delete all")
	}
...
func (o OperationTypeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from operationType slice")
	}
...
func (o *OperationType) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no OperationType provided for reload")
	}
...
func (o *OperationTypeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty OperationTypeSlice provided for reload all")
	}
...
func (o *OperationTypeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in OperationTypeSlice")
	}
...
func OperationTypeExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if operation_types exists")
	}
