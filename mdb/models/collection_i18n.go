...
func (q collectionI18nQuery) One() (*CollectionI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for collection_i18n")
	}
...
func (q collectionI18nQuery) All() (CollectionI18nSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to CollectionI18n slice")
	}
...
func (q collectionI18nQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count collection_i18n rows")
	}
...
func (q collectionI18nQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if collection_i18n exists")
	}
...
func FindCollectionI18n(exec boil.Executor, collectionID int64, language string, selectCols ...string) (*CollectionI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from collection_i18n")
	}
...
func (o *CollectionI18n) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no collection_i18n provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into collection_i18n")
	}
...
func (o *CollectionI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update collection_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update collection_i18n row")
	}
...
func (q collectionI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for collection_i18n")
	}
...
func (o CollectionI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in collectionI18n slice")
	}
...
func (o *CollectionI18n) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no CollectionI18n provided for deletion")
	}
...
func (o *CollectionI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no CollectionI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from collection_i18n")
	}
...
func (q collectionI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no collectionI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from collection_i18n")
	}
...
func (o CollectionI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no CollectionI18n slice provided for delete all")
	}
...
func (o CollectionI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from collectionI18n slice")
	}
...
func (o *CollectionI18n) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no CollectionI18n provided for reload")
	}
...
func (o *CollectionI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty CollectionI18nSlice provided for reload all")
	}
...
func (o *CollectionI18nSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in CollectionI18nSlice")
	}
...
func CollectionI18nExists(exec boil.Executor, collectionID int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if collection_i18n exists")
	}
