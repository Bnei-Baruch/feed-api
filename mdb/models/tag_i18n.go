...
func (q tagI18nQuery) All() (TagI18nSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to TagI18n slice")
	}
...
func (q tagI18nQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count tag_i18n rows")
	}
...
func (q tagI18nQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if tag_i18n exists")
	}
...
func FindTagI18n(exec boil.Executor, tagID int64, language string, selectCols ...string) (*TagI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from tag_i18n")
	}
...
func (o *TagI18n) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no tag_i18n provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into tag_i18n")
	}
...
func (o *TagI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update tag_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update tag_i18n row")
	}
...
func (q tagI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for tag_i18n")
	}
...
func (o TagI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in tagI18n slice")
	}
...
func (o *TagI18n) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no tag_i18n provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert tag_i18n, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert tag_i18n")
	}
...
func (o *TagI18n) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TagI18n provided for deletion")
	}
...
func (o *TagI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TagI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from tag_i18n")
	}
...
func (q tagI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no tagI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from tag_i18n")
	}
...
func (o TagI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TagI18n slice provided for delete all")
	}
...
func (o TagI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from tagI18n slice")
	}
...
func (o *TagI18n) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no TagI18n provided for reload")
	}
...
func (o *TagI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty TagI18nSlice provided for reload all")
	}
...
func (o *TagI18nSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&tagI18ns)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in TagI18nSlice")
	}
...
func TagI18nExists(exec boil.Executor, tagID int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if tag_i18n exists")
	}
