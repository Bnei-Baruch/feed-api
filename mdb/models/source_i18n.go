...
func (q sourceI18nQuery) One() (*SourceI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for source_i18n")
	}
...
func (q sourceI18nQuery) All() (SourceI18nSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to SourceI18n slice")
	}
...
func (q sourceI18nQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count source_i18n rows")
	}
...
func (q sourceI18nQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if source_i18n exists")
	}
...
func FindSourceI18n(exec boil.Executor, sourceID int64, language string, selectCols ...string) (*SourceI18n, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from source_i18n")
	}
...
func (o *SourceI18n) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no source_i18n provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into source_i18n")
	}
...
func (o *SourceI18n) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update source_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update source_i18n row")
	}
...
func (q sourceI18nQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for source_i18n")
	}
...
func (o SourceI18nSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in sourceI18n slice")
	}
...
func (o *SourceI18n) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no source_i18n provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert source_i18n, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert source_i18n")
	}
...
func (o *SourceI18n) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no SourceI18n provided for deletion")
	}
...
func (o *SourceI18n) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no SourceI18n provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from source_i18n")
	}
...
func (q sourceI18nQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no sourceI18nQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from source_i18n")
	}
...
func (o SourceI18nSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no SourceI18n slice provided for delete all")
	}
...
func (o SourceI18nSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from sourceI18n slice")
	}
...
func (o *SourceI18n) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no SourceI18n provided for reload")
	}
...
func (o *SourceI18nSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty SourceI18nSlice provided for reload all")
	}
...
func (o *SourceI18nSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in SourceI18nSlice")
	}
...
func SourceI18nExists(exec boil.Executor, sourceID int64, language string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if source_i18n exists")
	}
