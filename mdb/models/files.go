...
func (q fileQuery) One() (*File, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to execute a one query for files")
	}
...
func (q fileQuery) All() (FileSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "mdbmdbmodels: failed to assign all query results to File slice")
	}
...
func (q fileQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "mdbmdbmodels: failed to count files rows")
	}
...
func (q fileQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: failed to check if files exists")
	}
...
func FindFile(exec boil.Executor, id int64, selectCols ...string) (*File, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "mdbmdbmodels: unable to select from files")
	}
...
func (o *File) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no files provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to insert into files")
	}
...
func (o *File) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("mdbmdbmodels: unable to update files, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update files row")
	}
...
func (q fileQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all for files")
	}
...
func (o FileSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to update all in file slice")
	}
...
func (o *File) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no files provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("mdbmdbmodels: unable to upsert files, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to upsert files")
	}
...
func (o *File) DeleteG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no File provided for deletion")
	}
...
func (o *File) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("mdbmdbmodels: no File provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete from files")
	}
...
func (q fileQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("mdbmdbmodels: no fileQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from files")
	}
...
func (o FileSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no File slice provided for delete all")
	}
...
func (o FileSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to delete all from file slice")
	}
...
func (o *File) ReloadG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: no File provided for reload")
	}
...
func (o *FileSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("mdbmdbmodels: empty FileSlice provided for reload all")
	}
...
func (o *FileSlice) ReloadAll(exec boil.Executor) error {
	...
	err := q.Bind(&files)
	if err != nil {
		return errors.Wrap(err, "mdbmdbmodels: unable to reload all in FileSlice")
	}
...
func FileExists(exec boil.Executor, id int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "mdbmdbmodels: unable to check if files exists")
	}
