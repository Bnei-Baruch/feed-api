...
func testSourceI18nsDelete(t *testing.T) {
	...
	count, err := SourceI18ns().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testSourceI18nsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := SourceI18ns().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testSourceI18nsExists(t *testing.T) {
	...
	e, err := SourceI18nExists(ctx, tx, o.SourceID, o.Language)
	if err != nil {
...
func testSourceI18nsFind(t *testing.T) {
	...
	sourceI18nFound, err := FindSourceI18n(ctx, tx, o.SourceID, o.Language)
	if err != nil {
		t.Error(err)
	}
...
func testSourceI18nsBind(t *testing.T) {
	...
	if err = SourceI18ns().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testSourceI18nsOne(t *testing.T) {
	...
	if x, err := SourceI18ns().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testSourceI18nsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = sourceI18nOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = sourceI18nTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := SourceI18ns().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testSourceI18nsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(sourceI18nColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testSourceI18nToOneSourceUsingSource(t *testing.T) {
	...
	if err = local.L.LoadSource(ctx, tx, false, (*[]*SourceI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testSourceI18nToOneSetOpSourceUsingSource(t *testing.T) {
	...
	for i, x := range []*Source{&b, &c} {
		...
		if exists, err := SourceI18nExists(ctx, tx, a.SourceID, a.Language); err != nil {
			t.Fatal(err)
		} else if !exists {
