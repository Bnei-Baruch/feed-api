...
func testContentUnitDerivationsDelete(t *testing.T) {
	...
	count, err := ContentUnitDerivations().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitDerivationsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := ContentUnitDerivations().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testContentUnitDerivationsExists(t *testing.T) {
	...
	e, err := ContentUnitDerivationExists(ctx, tx, o.SourceID, o.DerivedID)
	if err != nil {
...
func testContentUnitDerivationsFind(t *testing.T) {
	...
	contentUnitDerivationFound, err := FindContentUnitDerivation(ctx, tx, o.SourceID, o.DerivedID)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitDerivationsBind(t *testing.T) {
	...
	if err = ContentUnitDerivations().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testContentUnitDerivationsOne(t *testing.T) {
	...
	if x, err := ContentUnitDerivations().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testContentUnitDerivationsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = contentUnitDerivationOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = contentUnitDerivationTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := ContentUnitDerivations().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitDerivationsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(contentUnitDerivationColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testContentUnitDerivationToOneContentUnitUsingDerived(t *testing.T) {
	...
	check, err := local.Derived().One(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	if err = local.L.LoadDerived(ctx, tx, false, (*[]*ContentUnitDerivation)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	local.R.Derived = nil
	if err = local.L.LoadDerived(ctx, tx, true, &local, nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Derived == nil {
		t.Error("struct should have been eager loaded")
...
func testContentUnitDerivationToOneContentUnitUsingSource(t *testing.T) {
	...
	slice := ContentUnitDerivationSlice{&local}
	if err = local.L.LoadSource(ctx, tx, false, (*[]*ContentUnitDerivation)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testContentUnitDerivationToOneSetOpContentUnitUsingDerived(t *testing.T) {
	...
	for i, x := range []*ContentUnit{&b, &c} {
		...
		if exists, err := ContentUnitDerivationExists(ctx, tx, a.SourceID, a.DerivedID); err != nil {
			t.Fatal(err)
		} else if !exists {
