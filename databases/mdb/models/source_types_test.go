...
func testSourceTypesDelete(t *testing.T) {
	...
	count, err := SourceTypes().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testSourceTypesQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := SourceTypes().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testSourceTypesExists(t *testing.T) {
	...
	e, err := SourceTypeExists(ctx, tx, o.ID)
	if err != nil {
...
func testSourceTypesFind(t *testing.T) {
	...
	sourceTypeFound, err := FindSourceType(ctx, tx, o.ID)
	if err != nil {
		t.Error(err)
	}
...
func testSourceTypesBind(t *testing.T) {
	...
	if err = SourceTypes().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testSourceTypesOne(t *testing.T) {
	...
	if x, err := SourceTypes().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testSourceTypesAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = sourceTypeOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = sourceTypeTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := SourceTypes().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testSourceTypesInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(sourceTypeColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testSourceTypeToManyTypeSources(t *testing.T) {
	...
	check, err := a.TypeSources().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadTypeSources(ctx, tx, false, (*[]*SourceType)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	a.R.TypeSources = nil
	if err = a.L.LoadTypeSources(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.TypeSources); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testSourceTypeToManyAddOpTypeSources(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddTypeSources(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.TypeSources().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
