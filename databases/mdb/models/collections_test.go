...
func testCollectionToManyCollectionI18ns(t *testing.T) {
	...
	if err = a.L.LoadCollectionI18ns(ctx, tx, false, (*[]*Collection)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testCollectionToManyCollectionsContentUnits(t *testing.T) {
	...
	slice := CollectionSlice{&a}
	if err = a.L.LoadCollectionsContentUnits(ctx, tx, false, (*[]*Collection)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testCollectionToOneContentTypeUsingType(t *testing.T) {
	...
	if err = local.L.LoadType(ctx, tx, false, (*[]*Collection)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Type == nil {
