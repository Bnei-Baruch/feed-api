...
func testContentUnitsDelete(t *testing.T) {
	...
	count, err := ContentUnits().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := ContentUnits().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testContentUnitsExists(t *testing.T) {
	...
	e, err := ContentUnitExists(ctx, tx, o.ID)
	if err != nil {
...
func testContentUnitsFind(t *testing.T) {
	...
	contentUnitFound, err := FindContentUnit(ctx, tx, o.ID)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitsBind(t *testing.T) {
	...
	if err = ContentUnits().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testContentUnitsOne(t *testing.T) {
	...
	if x, err := ContentUnits().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testContentUnitsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = contentUnitOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = contentUnitTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := ContentUnits().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(contentUnitColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testContentUnitToManyCollectionsContentUnits(t *testing.T) {
	...
	check, err := a.CollectionsContentUnits().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadCollectionsContentUnits(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadCollectionsContentUnits(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.CollectionsContentUnits); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testContentUnitToManyDerivedContentUnitDerivations(t *testing.T) {
	...
	check, err := a.DerivedContentUnitDerivations().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := ContentUnitSlice{&a}
	if err = a.L.LoadDerivedContentUnitDerivations(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadDerivedContentUnitDerivations(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.DerivedContentUnitDerivations); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testContentUnitToManySourceContentUnitDerivations(t *testing.T) {
	...
	check, err := a.SourceContentUnitDerivations().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := ContentUnitSlice{&a}
	if err = a.L.LoadSourceContentUnitDerivations(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadSourceContentUnitDerivations(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.SourceContentUnitDerivations); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testContentUnitToManyContentUnitI18ns(t *testing.T) {
	...
	check, err := a.ContentUnitI18ns().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := ContentUnitSlice{&a}
	if err = a.L.LoadContentUnitI18ns(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadContentUnitI18ns(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ContentUnitI18ns); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testContentUnitToManyContentUnitsPersons(t *testing.T) {
	...
	check, err := a.ContentUnitsPersons().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := ContentUnitSlice{&a}
	if err = a.L.LoadContentUnitsPersons(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadContentUnitsPersons(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ContentUnitsPersons); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testContentUnitToManyPublishers(t *testing.T) {
	...
	check, err := a.Publishers().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := ContentUnitSlice{&a}
	if err = a.L.LoadPublishers(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	a.R.Publishers = nil
	if err = a.L.LoadPublishers(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.Publishers); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testContentUnitToManySources(t *testing.T) {
	...
	slice := ContentUnitSlice{&a}
	if err = a.L.LoadSources(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testContentUnitToManyTags(t *testing.T) {
	...
	slice := ContentUnitSlice{&a}
	if err = a.L.LoadTags(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testContentUnitToManyFiles(t *testing.T) {
	...
	slice := ContentUnitSlice{&a}
	if err = a.L.LoadFiles(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testContentUnitToManyAddOpCollectionsContentUnits(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddCollectionsContentUnits(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.CollectionsContentUnits().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
...
func testContentUnitToManyAddOpDerivedContentUnitDerivations(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddDerivedContentUnitDerivations(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.DerivedContentUnitDerivations().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testContentUnitToManyAddOpSourceContentUnitDerivations(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddSourceContentUnitDerivations(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.SourceContentUnitDerivations().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testContentUnitToManyAddOpContentUnitI18ns(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddContentUnitI18ns(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.ContentUnitI18ns().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testContentUnitToManyAddOpContentUnitsPersons(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddContentUnitsPersons(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.ContentUnitsPersons().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testContentUnitToManyAddOpPublishers(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddPublishers(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.Publishers().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testContentUnitToManySetOpPublishers(t *testing.T) {
	...
	err = a.SetPublishers(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetPublishers(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testContentUnitToManyRemoveOpPublishers(t *testing.T) {
	...
	err = a.AddPublishers(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemovePublishers(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testContentUnitToOneContentTypeUsingType(t *testing.T) {
	...
	if err = local.L.LoadType(ctx, tx, false, (*[]*ContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Type == nil {
