...
func testContentUnitI18nsDelete(t *testing.T) {
	...
	count, err := ContentUnitI18ns().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitI18nsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := ContentUnitI18ns().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testContentUnitI18nsExists(t *testing.T) {
	...
	e, err := ContentUnitI18nExists(ctx, tx, o.ContentUnitID, o.Language)
	if err != nil {
...
func testContentUnitI18nsFind(t *testing.T) {
	...
	contentUnitI18nFound, err := FindContentUnitI18n(ctx, tx, o.ContentUnitID, o.Language)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitI18nsBind(t *testing.T) {
	...
	if err = ContentUnitI18ns().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testContentUnitI18nsOne(t *testing.T) {
	...
	if x, err := ContentUnitI18ns().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testContentUnitI18nsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = contentUnitI18nOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = contentUnitI18nTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := ContentUnitI18ns().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitI18nsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(contentUnitI18nColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testContentUnitI18nToOneContentUnitUsingContentUnit(t *testing.T) {
	...
	if err = local.L.LoadContentUnit(ctx, tx, false, (*[]*ContentUnitI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testContentUnitI18nToOneUserUsingUser(t *testing.T) {
	...
	slice := ContentUnitI18nSlice{&local}
	if err = local.L.LoadUser(ctx, tx, false, (*[]*ContentUnitI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.User == nil {
		t.Error("struct should have been eager loaded")
...
func testContentUnitI18nToOneSetOpContentUnitUsingContentUnit(t *testing.T) {
	...
	for i, x := range []*ContentUnit{&b, &c} {
		...
		if exists, err := ContentUnitI18nExists(ctx, tx, a.ContentUnitID, a.Language); err != nil {
			t.Fatal(err)
		} else if !exists {
