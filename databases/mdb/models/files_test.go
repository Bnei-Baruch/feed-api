...
func testFileToManyParentFiles(t *testing.T) {
	...
	check, err := a.ParentFiles().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := FileSlice{&a}
	if err = a.L.LoadParentFiles(ctx, tx, false, (*[]*File)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	a.R.ParentFiles = nil
	if err = a.L.LoadParentFiles(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ParentFiles); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testFileToManyOperations(t *testing.T) {
	...
	slice := FileSlice{&a}
	if err = a.L.LoadOperations(ctx, tx, false, (*[]*File)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testFileToManyStorages(t *testing.T) {
	...
	check, err := a.Storages().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := FileSlice{&a}
	if err = a.L.LoadStorages(ctx, tx, false, (*[]*File)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	a.R.Storages = nil
	if err = a.L.LoadStorages(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.Storages); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testFileToManyAddOpParentFiles(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddParentFiles(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.ParentFiles().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
...
func testFileToManySetOpParentFiles(t *testing.T) {
	...
	err = a.SetParentFiles(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetParentFiles(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testFileToManyRemoveOpParentFiles(t *testing.T) {
	...
	err = a.AddParentFiles(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveParentFiles(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testFileToManyAddOpStorages(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddStorages(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.Storages().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testFileToManySetOpStorages(t *testing.T) {
	...
	err = a.SetStorages(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetStorages(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testFileToManyRemoveOpStorages(t *testing.T) {
	...
	err = a.AddStorages(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveStorages(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testFileToOneContentUnitUsingContentUnit(t *testing.T) {
	...
	check, err := local.ContentUnit().One(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	if err = local.L.LoadContentUnit(ctx, tx, false, (*[]*File)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	if err = local.L.LoadContentUnit(ctx, tx, true, &local, nil); err != nil {
		t.Fatal(err)
	}
	if local.R.ContentUnit == nil {
		t.Error("struct should have been eager loaded")
...
func testFileToOneFileUsingParent(t *testing.T) {
	...
	slice := FileSlice{&local}
	if err = local.L.LoadParent(ctx, tx, false, (*[]*File)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testFileToOneSetOpContentUnitUsingContentUnit(t *testing.T) {
	...
	for i, x := range []*ContentUnit{&b, &c} {
		err = a.SetContentUnit(ctx, tx, i != 0, x)
		if err != nil {
			t.Fatal(err)
		}
...
func testFileToOneRemoveOpContentUnitUsingContentUnit(t *testing.T) {
	...
	if err = a.SetContentUnit(ctx, tx, true, &b); err != nil {
		t.Fatal(err)
	}

	if err = a.RemoveContentUnit(ctx, tx, &b); err != nil {
		t.Error("failed to remove relationship")
	}

	count, err := a.ContentUnit().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
	if count != 0 {
