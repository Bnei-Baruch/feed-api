...
func testContentUnitsPersonsDelete(t *testing.T) {
	...
	count, err := ContentUnitsPersons().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitsPersonsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := ContentUnitsPersons().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testContentUnitsPersonsExists(t *testing.T) {
	...
	e, err := ContentUnitsPersonExists(ctx, tx, o.ContentUnitID, o.PersonID)
	if err != nil {
...
func testContentUnitsPersonsFind(t *testing.T) {
	...
	contentUnitsPersonFound, err := FindContentUnitsPerson(ctx, tx, o.ContentUnitID, o.PersonID)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitsPersonsBind(t *testing.T) {
	...
	if err = ContentUnitsPersons().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testContentUnitsPersonsOne(t *testing.T) {
	...
	if x, err := ContentUnitsPersons().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testContentUnitsPersonsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = contentUnitsPersonOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = contentUnitsPersonTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := ContentUnitsPersons().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testContentUnitsPersonsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(contentUnitsPersonColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testContentUnitsPersonToOneContentUnitUsingContentUnit(t *testing.T) {
	...
	if err = local.L.LoadContentUnit(ctx, tx, false, (*[]*ContentUnitsPerson)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testContentUnitsPersonToOnePersonUsingPerson(t *testing.T) {
	...
	slice := ContentUnitsPersonSlice{&local}
	if err = local.L.LoadPerson(ctx, tx, false, (*[]*ContentUnitsPerson)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testContentUnitsPersonToOneContentRoleTypeUsingRole(t *testing.T) {
	...
	slice := ContentUnitsPersonSlice{&local}
	if err = local.L.LoadRole(ctx, tx, false, (*[]*ContentUnitsPerson)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Role == nil {
		t.Error("struct should have been eager loaded")
...
func testContentUnitsPersonToOneSetOpContentUnitUsingContentUnit(t *testing.T) {
	...
	for i, x := range []*ContentUnit{&b, &c} {
		...
		if exists, err := ContentUnitsPersonExists(ctx, tx, a.ContentUnitID, a.PersonID); err != nil {
			t.Fatal(err)
		} else if !exists {
