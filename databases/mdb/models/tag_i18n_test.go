...
func testTagI18nsDelete(t *testing.T) {
	...
	count, err := TagI18ns().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testTagI18nsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := TagI18ns().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testTagI18nsExists(t *testing.T) {
	...
	e, err := TagI18nExists(ctx, tx, o.TagID, o.Language)
	if err != nil {
...
func testTagI18nsFind(t *testing.T) {
	...
	tagI18nFound, err := FindTagI18n(ctx, tx, o.TagID, o.Language)
	if err != nil {
		t.Error(err)
	}
...
func testTagI18nsBind(t *testing.T) {
	...
	if err = TagI18ns().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testTagI18nsOne(t *testing.T) {
	...
	if x, err := TagI18ns().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testTagI18nsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = tagI18nOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = tagI18nTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := TagI18ns().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testTagI18nsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(tagI18nColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testTagI18nToOneTagUsingTag(t *testing.T) {
	...
	if err = local.L.LoadTag(ctx, tx, false, (*[]*TagI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Tag == nil {
...
func testTagI18nToOneUserUsingUser(t *testing.T) {
	...
	slice := TagI18nSlice{&local}
	if err = local.L.LoadUser(ctx, tx, false, (*[]*TagI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.User == nil {
		t.Error("struct should have been eager loaded")
...
func testTagI18nToOneSetOpTagUsingTag(t *testing.T) {
	...
	for i, x := range []*Tag{&b, &c} {
		...
		if exists, err := TagI18nExists(ctx, tx, a.TagID, a.Language); err != nil {
			t.Fatal(err)
		} else if !exists {
