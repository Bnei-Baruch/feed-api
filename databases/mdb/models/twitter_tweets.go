...
func (q twitterTweetQuery) One(ctx context.Context, exec boil.ContextExecutor) (*TwitterTweet, error) {
	o := &TwitterTweet{}
...
func (q twitterTweetQuery) All(ctx context.Context, exec boil.ContextExecutor) (TwitterTweetSlice, error) {
	var o []*TwitterTweet
...
func (q twitterTweetQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	var count int64
...
func (q twitterTweetQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	var count int64
...
func (twitterTweetL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTwitterTweet interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`twitter_users`), qm.WhereIn(`twitter_users.id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *TwitterTweet) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *TwitterUser) error {
	var err error
	if insert {
...
func FindTwitterTweet(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*TwitterTweet, error) {
	...
	err := q.Bind(ctx, exec, twitterTweetObj)
	if err != nil {
		if errors.Cause(err) == sql.ErrNoRows {
			return nil, sql.ErrNoRows
		}
...
func (o *TwitterTweet) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
...
func (o *TwitterTweet) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	var err error
...
func (q twitterTweetQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
...
func (o TwitterTweetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
...
func (o *TwitterTweet) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
...
func (o *TwitterTweet) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
...
func (q twitterTweetQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
...
func (o TwitterTweetSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
...
func (o *TwitterTweet) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindTwitterTweet(ctx, exec, o.ID)
	if err != nil {
		return err
	}
...
func (o *TwitterTweetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
...
func TwitterTweetExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
