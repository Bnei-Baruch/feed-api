...
func testCollectionI18nsDelete(t *testing.T) {
	...
	count, err := CollectionI18ns().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testCollectionI18nsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := CollectionI18ns().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testCollectionI18nsExists(t *testing.T) {
	...
	e, err := CollectionI18nExists(ctx, tx, o.CollectionID, o.Language)
	if err != nil {
...
func testCollectionI18nsFind(t *testing.T) {
	...
	collectionI18nFound, err := FindCollectionI18n(ctx, tx, o.CollectionID, o.Language)
	if err != nil {
		t.Error(err)
	}
...
func testCollectionI18nsBind(t *testing.T) {
	...
	if err = CollectionI18ns().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testCollectionI18nsOne(t *testing.T) {
	...
	if x, err := CollectionI18ns().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testCollectionI18nsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = collectionI18nOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = collectionI18nTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := CollectionI18ns().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testCollectionI18nsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(collectionI18nColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testCollectionI18nToOneCollectionUsingCollection(t *testing.T) {
	...
	if err = local.L.LoadCollection(ctx, tx, false, (*[]*CollectionI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testCollectionI18nToOneUserUsingUser(t *testing.T) {
	...
	slice := CollectionI18nSlice{&local}
	if err = local.L.LoadUser(ctx, tx, false, (*[]*CollectionI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.User == nil {
		t.Error("struct should have been eager loaded")
...
func testCollectionI18nToOneSetOpCollectionUsingCollection(t *testing.T) {
	...
	for i, x := range []*Collection{&b, &c} {
		...
		if exists, err := CollectionI18nExists(ctx, tx, a.CollectionID, a.Language); err != nil {
			t.Fatal(err)
		} else if !exists {
