...
func testUserToManyCollectionI18ns(t *testing.T) {
	...
	check, err := a.CollectionI18ns().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadCollectionI18ns(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadCollectionI18ns(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.CollectionI18ns); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyContentUnitI18ns(t *testing.T) {
	...
	slice := UserSlice{&a}
	if err = a.L.LoadContentUnitI18ns(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyOperations(t *testing.T) {
	...
	check, err := a.Operations().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadOperations(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	a.R.Operations = nil
	if err = a.L.LoadOperations(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.Operations); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyPersonI18ns(t *testing.T) {
	...
	check, err := a.PersonI18ns().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadPersonI18ns(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	a.R.PersonI18ns = nil
	if err = a.L.LoadPersonI18ns(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.PersonI18ns); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyPublisherI18ns(t *testing.T) {
	...
	check, err := a.PublisherI18ns().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadPublisherI18ns(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadPublisherI18ns(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.PublisherI18ns); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyTagI18ns(t *testing.T) {
	...
	slice := UserSlice{&a}
	if err = a.L.LoadTagI18ns(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpCollectionI18ns(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddCollectionI18ns(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.CollectionI18ns().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
...
func testUserToManySetOpCollectionI18ns(t *testing.T) {
	...
	err = a.SetCollectionI18ns(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetCollectionI18ns(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpCollectionI18ns(t *testing.T) {
	...
	err = a.AddCollectionI18ns(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveCollectionI18ns(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManySetOpContentUnitI18ns(t *testing.T) {
	...
	err = a.SetContentUnitI18ns(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetContentUnitI18ns(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpContentUnitI18ns(t *testing.T) {
	...
	err = a.AddContentUnitI18ns(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveContentUnitI18ns(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpOperations(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddOperations(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.Operations().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManySetOpOperations(t *testing.T) {
	...
	err = a.SetOperations(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetOperations(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpOperations(t *testing.T) {
	...
	err = a.AddOperations(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveOperations(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpPersonI18ns(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddPersonI18ns(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.PersonI18ns().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManySetOpPersonI18ns(t *testing.T) {
	...
	err = a.SetPersonI18ns(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetPersonI18ns(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpPersonI18ns(t *testing.T) {
	...
	err = a.AddPersonI18ns(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemovePersonI18ns(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpPublisherI18ns(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddPublisherI18ns(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.PublisherI18ns().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManySetOpPublisherI18ns(t *testing.T) {
	...
	err = a.SetPublisherI18ns(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetPublisherI18ns(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpPublisherI18ns(t *testing.T) {
	...
	err = a.AddPublisherI18ns(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemovePublisherI18ns(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManySetOpTagI18ns(t *testing.T) {
	...
	err = a.SetTagI18ns(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetTagI18ns(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpTagI18ns(t *testing.T) {
	...
	err = a.AddTagI18ns(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveTagI18ns(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
