...
func testCollectionsContentUnitsDelete(t *testing.T) {
	...
	count, err := CollectionsContentUnits().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testCollectionsContentUnitsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := CollectionsContentUnits().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testCollectionsContentUnitsExists(t *testing.T) {
	...
	e, err := CollectionsContentUnitExists(ctx, tx, o.CollectionID, o.ContentUnitID)
	if err != nil {
...
func testCollectionsContentUnitsFind(t *testing.T) {
	...
	collectionsContentUnitFound, err := FindCollectionsContentUnit(ctx, tx, o.CollectionID, o.ContentUnitID)
	if err != nil {
		t.Error(err)
	}
...
func testCollectionsContentUnitsBind(t *testing.T) {
	...
	if err = CollectionsContentUnits().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testCollectionsContentUnitsOne(t *testing.T) {
	...
	if x, err := CollectionsContentUnits().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testCollectionsContentUnitsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = collectionsContentUnitOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = collectionsContentUnitTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := CollectionsContentUnits().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testCollectionsContentUnitsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(collectionsContentUnitColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testCollectionsContentUnitToOneCollectionUsingCollection(t *testing.T) {
	...
	if err = local.L.LoadCollection(ctx, tx, false, (*[]*CollectionsContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testCollectionsContentUnitToOneContentUnitUsingContentUnit(t *testing.T) {
	...
	slice := CollectionsContentUnitSlice{&local}
	if err = local.L.LoadContentUnit(ctx, tx, false, (*[]*CollectionsContentUnit)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testCollectionsContentUnitToOneSetOpCollectionUsingCollection(t *testing.T) {
	...
	for i, x := range []*Collection{&b, &c} {
		...
		if exists, err := CollectionsContentUnitExists(ctx, tx, a.CollectionID, a.ContentUnitID); err != nil {
			t.Fatal(err)
		} else if !exists {
