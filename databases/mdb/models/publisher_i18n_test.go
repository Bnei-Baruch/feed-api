...
func testPublisherI18nsDelete(t *testing.T) {
	...
	count, err := PublisherI18ns().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testPublisherI18nsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := PublisherI18ns().DeleteAll(ctx, tx); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testPublisherI18nsExists(t *testing.T) {
	...
	e, err := PublisherI18nExists(ctx, tx, o.PublisherID, o.Language)
	if err != nil {
...
func testPublisherI18nsFind(t *testing.T) {
	...
	publisherI18nFound, err := FindPublisherI18n(ctx, tx, o.PublisherID, o.Language)
	if err != nil {
		t.Error(err)
	}
...
func testPublisherI18nsBind(t *testing.T) {
	...
	if err = PublisherI18ns().Bind(ctx, tx, o); err != nil {
		t.Error(err)
	}
}
...
func testPublisherI18nsOne(t *testing.T) {
	...
	if x, err := PublisherI18ns().One(ctx, tx); err != nil {
		t.Error(err)
	} else if x == nil {
...
func testPublisherI18nsAll(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = publisherI18nOne.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}
	if err = publisherI18nTwo.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Error(err)
	}

	slice, err := PublisherI18ns().All(ctx, tx)
	if err != nil {
		t.Error(err)
	}
...
func testPublisherI18nsInsertWhitelist(t *testing.T) {
	...
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	if err = o.Insert(ctx, tx, boil.Whitelist(publisherI18nColumnsWithoutDefault...)); err != nil {
		t.Error(err)
	}
...
func testPublisherI18nToOnePublisherUsingPublisher(t *testing.T) {
	...
	if err = local.L.LoadPublisher(ctx, tx, false, (*[]*PublisherI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testPublisherI18nToOneUserUsingUser(t *testing.T) {
	...
	slice := PublisherI18nSlice{&local}
	if err = local.L.LoadUser(ctx, tx, false, (*[]*PublisherI18n)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.User == nil {
		t.Error("struct should have been eager loaded")
...
func testPublisherI18nToOneSetOpPublisherUsingPublisher(t *testing.T) {
	...
	for i, x := range []*Publisher{&b, &c} {
		...
		if exists, err := PublisherI18nExists(ctx, tx, a.PublisherID, a.Language); err != nil {
			t.Fatal(err)
		} else if !exists {
