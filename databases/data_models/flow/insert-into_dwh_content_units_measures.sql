...
count (distinct case when dwh_update_datetime >= NOW() - (10 * interval '1 minute') then event_user_id else null end) as unique_users_last10min_count,
max(NOW()) as dwh_update_datetime
