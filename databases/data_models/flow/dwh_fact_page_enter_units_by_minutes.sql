insert into dwh_fact_page_enter_units_by_minutes
...
select 
  ...
  select
    data->>''unit_uid'' as event_unit_uid,             
    ...
    id as event_id
  from entries
  where client_event_type=''unit-page-enter''
    /** for incremental loading **/ 
  and id > ''$page-enter-minutes-prev-read-id''
  ') as a(
