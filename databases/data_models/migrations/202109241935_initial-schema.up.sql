...
CREATE TABLE IF NOT EXISTS public.dwh_content_units_measures
(
    event_unit_uid text COLLATE "default" NOT NULL,
    all_events_count bigint,
    unique_users_watching_now_count bigint,
...
CREATE INDEX ind_dwh_fact_play_units_by_minutes_event_user_id ON public.dwh_fact_play_units_by_minutes USING btree (event_unit_uid, event_user_id);
