...
var DWHFactPlayUnitsByMinuteTableColumns = struct {
	EventUnitUID        string
	EventUserID         string
	EventLanguage       string
	EventUserAgentType  string
	...
	EventUnitUID:        "dwh_fact_play_units_by_minutes.event_unit_uid",
	EventUserID:         "dwh_fact_play_units_by_minutes.event_user_id",
	EventLanguage:       "dwh_fact_play_units_by_minutes.event_language",
	EventUserAgentType:  "dwh_fact_play_units_by_minutes.event_user_agent_type",
	EventEndMinute:      "dwh_fact_play_units_by_minutes.event_end_minute",
	EventEndIDMax:       "dwh_fact_play_units_by_minutes.event_end_id_max",
	EventCount:          "dwh_fact_play_units_by_minutes.event_count",
	EventDurationSecSum: "dwh_fact_play_units_by_minutes.event_duration_sec_sum",
	DWHUpdateDatetime:   "dwh_fact_play_units_by_minutes.dwh_update_datetime",
}
...
var (
	...
	dwhFactPlayUnitsByMinuteColumnsWithoutDefault = []string{"event_end_id_max"}
	dwhFactPlayUnitsByMinuteColumnsWithDefault    = []string{"event_unit_uid", "event_user_id", "event_language", "event_user_agent_type", "event_end_minute", "event_count", "event_duration_sec_sum", "dwh_update_datetime"}
	dwhFactPlayUnitsByMinutePrimaryKeyColumns     = []string{"event_end_id_max"}
	dwhFactPlayUnitsByMinuteGeneratedColumns      = []string{}
)

type (
	// DWHFactPlayUnitsByMinuteSlice is an alias for a slice of pointers to DWHFactPlayUnitsByMinute.
	// This should almost always be used instead of []DWHFactPlayUnitsByMinute.
...
func DWHFactPlayUnitsByMinutes(mods ...qm.QueryMod) dwhFactPlayUnitsByMinuteQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"dwh_fact_play_units_by_minutes\".*"})
	}
