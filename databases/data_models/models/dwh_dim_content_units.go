...
var DWHDimContentUnitTableColumns = struct {
	ContentUnitID        string
	ContentUnitUID       string
	ContentUnitCreatedAt string
	ContentUnitDuration  string
	...
	ContentUnitID:        "dwh_dim_content_units.content_unit_id",
	ContentUnitUID:       "dwh_dim_content_units.content_unit_uid",
	ContentUnitCreatedAt: "dwh_dim_content_units.content_unit_created_at",
	ContentUnitDuration:  "dwh_dim_content_units.content_unit_duration",
	ContentUnitTypeID:    "dwh_dim_content_units.content_unit_type_id",
	ContentUnitTypeName:  "dwh_dim_content_units.content_unit_type_name",
	ContentUnitName:      "dwh_dim_content_units.content_unit_name",
	ContentUnitLanguage:  "dwh_dim_content_units.content_unit_language",
}
...
var (
	...
	dwhDimContentUnitColumnsWithoutDefault = []string{"content_unit_uid", "content_unit_language"}
	dwhDimContentUnitColumnsWithDefault    = []string{"content_unit_id", "content_unit_created_at", "content_unit_duration", "content_unit_type_id", "content_unit_type_name", "content_unit_name"}
	dwhDimContentUnitPrimaryKeyColumns     = []string{"content_unit_uid", "content_unit_language"}
	dwhDimContentUnitGeneratedColumns      = []string{}
)

type (
	// DWHDimContentUnitSlice is an alias for a slice of pointers to DWHDimContentUnit.
	// This should almost always be used instead of []DWHDimContentUnit.
...
func DWHDimContentUnits(mods ...qm.QueryMod) dwhDimContentUnitQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"dwh_dim_content_units\".*"})
	}
