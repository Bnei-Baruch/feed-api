...
export const COLLECTION_TYPES_SET = new Set([
    CT_DAILY_LESSON, CT_SPECIAL_LESSON, CT_FRIENDS_GATHERINGS, CT_VIDEO_PROGRAM, CT_LECTURE_SERIES,
    CT_CHILDREN_LESSONS, CT_WOMEN_LESSONS, CT_VIRTUAL_LESSONS, CT_MEALS, CT_CONGRESS, CT_HOLIDAY,
    CT_PICNIC, CT_UNITY_DAY, CT_CLIPS, CT_ARTICLES, CT_LESSONS_SERIES, 
]);
...
export const CONTENT_UNIT_TYPES_SET = new Set([
    CT_LESSON_PART, CT_LECTURE, CT_CHILDREN_LESSON, CT_WOMEN_LESSON, CT_VIRTUAL_LESSON, CT_FRIENDS_GATHERING,
    CT_MEAL, CT_VIDEO_PROGRAM_CHAPTER, CT_FULL_LESSON, CT_ARTICLE, CT_UNKNOWN, CT_EVENT_PART, CT_CLIP,
    CT_TRAINING, CT_KITEI_MAKOR, CT_PUBLICATION, CT_LELO_MIKUD, CT_BLOG_POST, CT_RESEARCH_MATERIAL, CT_KTAIM_NIVCHARIM,
]);
